...
public class ItemAetheriumClockworkPickaxe extends ItemTool implements IModeledItem, IEmberChargedTool {
	
	public static ToolMaterial materialClockworkAxe = EnumHelper.addToolMaterial(AetheriumAshenArmor.MODID+":aetheriumClockworkAxe", 3, -1, 18.0f, 5.0f, 22);

	public ItemAetheriumClockworkPickaxe(String name, boolean addToTab) {
