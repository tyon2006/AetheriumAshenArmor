...
public class ItemAetheriumClockworkAxe extends ItemTool implements IModeledItem, IEmberChargedTool {
	...
	public ItemAetheriumClockworkAxe(String name, boolean addToTab) {
