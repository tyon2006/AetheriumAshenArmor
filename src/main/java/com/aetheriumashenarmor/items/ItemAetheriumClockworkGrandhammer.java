...
public class ItemAetheriumClockworkGrandhammer extends ItemTool implements IModeledItem, IEmberChargedTool {
	
	public static ToolMaterial materialAetheriumGrandhammer = EnumHelper.addToolMaterial(AetheriumAshenArmor.MODID+":grandhammer", 1, -1, 6.0f, 6.0f, 22);
	
	public ItemAetheriumClockworkGrandhammer(String name, boolean addToTab) {
